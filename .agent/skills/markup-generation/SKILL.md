...
description: Use when translating Figma designs into production-ready React (Vite) components. Governs the end-to-end workflow (Phase 0→3) for translating Figma designs into production-ready React (Vite) components.
...
# Markup Generation (React / Vite)

This skill governs the end-to-end workflow for translating Figma designs into production-ready React components using React and Tailwind CSS v4. It ensures mobile-first, accessible, and semantic output across all breakpoints.
