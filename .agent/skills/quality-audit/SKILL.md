---
name: quality-audit
description: Comprehensive quality audit for frontend changes including a11y, vercel-react-best-practices, and design consistency. Use for final verification before PR or task completion.
category: Standards
...
- [ ] **React Components**: Functional components used by default; clean lifecycle management.
- [ ] **React Vite Caching & State**: Correct caching using React Query or standard state hooks.
