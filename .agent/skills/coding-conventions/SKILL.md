...
description: Project-wide naming and coding conventions for files, variables, functions, and React components. Use when writing new code, reviewing code, or before committing changes in React/Vite projects. Covers PascalCase components, kebab-case TS files, and event handler patterns.
category: Standards
...
## Scope
- **Use for**: Writing new code, code reviews, pre-commit verification in React/Vite projects.
- **Core Focus**: Naming rules (files, variables, functions) + React patterns + TypeScript best practices.
- **Applies to**: React/Vite projects.
...
## 3) React Patterns (required)

Read the detailed rules: [react-patterns](references/react-next-patterns.md)
