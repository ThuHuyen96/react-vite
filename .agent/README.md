...
| **[coding-conventions](./skills/coding-conventions/SKILL.md)** | Project-wide naming and coding conventions for files, variables, functions, and React components. Use when writing new code, reviewing code, or before committing changes in React/Vite projects. Covers | — | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
...
| **[quality-audit](./skills/quality-audit/SKILL.md)** | Comprehensive quality audit for frontend changes including a11y, vercel-react-best-practices, and design consistency. Use for final verification before PR or task completion. | `a11y-wcag`, `vercel-react-best-practices`, `coding-conventions`, `react-useeffect`, `review-react`, `vercel-composition-patterns` | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
...
| **[markup-generation](./skills/markup-generation/SKILL.md)** | Use when translating Figma designs into production-ready React (Vite) components. Governs the end-to-end workflow (Phase 0→3) for translating Figma designs into production-ready React (Vite) component | `.agent/skills/css-sizing/SKILL.md`, `.agent/skills/figma-layout-intent/SKILL.md`, `.agent/skills/markup-generation/references/semantic.md`, `.agent/skills/markup-generation/references/a11y.md`, `.agent/skills/markup-generation/references/tokens-tailwind.md` | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
...
| **[figma-to-react-component](./skills/figma-to-react-component/SKILL.md)** | Extract Figma node data via MCP and implement a polished React component using the project's existing component library and design tokens. Use when converting a Figma URL or node into an independent . | `vercel-react-best-practices` | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
...
| Skill | Description | Deps | Status | Benchmark | AI Check | Reviewed |
| :--- | :--- | :--- | :---: | :---: | :---: | :---: |
| **[react-manifesto](./skills/react-manifesto/SKILL.md)** | Foundational principles, core stack (React, Vite, Tailwind), and operational workflow for AI Agent development in React projects. Use when establishing project methodology or defining development stan | — | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
...
| **[review-react](./skills/review-react/SKILL.md)** | Use when writing, reviewing, or refactoring React components, hooks, or state management code. React code review guidelines covering Rules of React, re-render optimization, rendering performance, and  | — | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
| **[vercel-composition-patterns](./skills/vercel-composition-patterns/SKILL.md)** | Use when refactoring components with boolean prop proliferation, building flexible component libraries, or designing reusable APIs. Triggers on tasks involving compound components, render props, conte | — | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
| **[vercel-react-best-practices](./skills/vercel-react-best-practices/SKILL.md)** | React and Next.js performance optimization guidelines from Vercel Engineering. Use when writing, reviewing, or refactoring React/Next.js code to ensure optimal performance patterns. Triggers on tasks  | — | 🚧 Draft | 🟢 PASS | ⚪ N/A | ⚠️ |
